...
namespace IPSDataAcquisition.Infrastructure.Migrations
{
    ...
    [Migration("20251023122724_AddQualityMetricsToSessions")]
    partial class AddQualityMetricsToSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IPSDataAcquisition.Domain.Entities.AppVersion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("Active")
                        .HasDatabaseName("ix_app_versions_active");

                    b.HasIndex("VersionName")
                        .IsUnique()
                        .HasDatabaseName("ix_app_versions_version_name");
            ...
            modelBuilder.Entity("IPSDataAcquisition.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<decimal?>("AccelDataCoverage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("accel_data_coverage")
                        .HasComment("Percentage of records with accelerometer data (0-100)");

                    b.Property<decimal?>("BarometerDataCoverage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("barometer_data_coverage")
                    ...
                    b.Property<decimal?>("GpsDataCoverage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("gps_data_coverage")
                        .HasComment("Percentage of records with GPS data (0-100)");

                    b.Property<decimal?>("GyroDataCoverage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("gyro_data_coverage")
                    ...
                    b.Property<bool>("HasAnomalies")
                        ...
                        .HasColumnName("has_anomalies")
                        .HasComment("Flag indicating if sensor anomalies were detected");

                    b.Property<bool>("HasDataGaps")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("has_data_gaps")
                    ...
                    b.Property<decimal?>("MagDataCoverage")
                        .HasColumnType("decimal(5,2)")
                        .HasColumnName("mag_data_coverage")
                    ...
                    b.Property<string>("QualityMetricsRawJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("quality_metrics_raw_json")
                        .HasComment("Extended quality metrics and ML features in JSON format");

                    b.Property<string>("QualityRemarks")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("quality_remarks")
                    ...
                    b.Property<int?>("TotalButtonPresses")
                        .HasColumnType("integer")
                        .HasColumnName("total_button_presses")
                        .HasComment("Total number of button press events");

                    b.Property<int?>("TotalIMUDataPoints")
                        .HasColumnType("integer")
                        .HasColumnName("total_imu_data_points")
                    ...
                    b.HasIndex("QualityScore", "HasAnomalies", "Status")
