...
public record UploadIMUDataRequestDto(string? SessionId, List<IMUDataPointDto> DataPoints);
...
public record UploadIMUDataResponseDto(int PointsReceived, string? SessionId);
